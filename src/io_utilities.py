...
class DataSetContainer:
    ...
    def __init__(self, folderprefix, dataset_number = None):
        ...
        self.twistplotpath    = os.path.join(self.plotpath, "twist.eps")
        self.catplotpath      = os.path.join(self.plotpath, "categorize.eps")
        self.dispplotpath     = os.path.join(self.plotpath, "displacement.eps")
        self.dispbin2plotpath = os.path.join(self.plotpath, "displacementbin2.eps")
        self.shearplotpath    = os.path.join(self.plotpath, "shear.eps")
        self.dilplotpath      = os.path.join(self.plotpath, "dilation.eps")
        self.adjplotpath      = os.path.join(self.plotpath, "adjacencies.eps")
        self.rotplotpath      = os.path.join(self.plotpath, "rotation.eps")
        self.vdfplotpath      = os.path.join(self.plotpath, "vdf.eps")
        self.diskplotpath     = os.path.join(self.plotpath, "disks.eps")
        self.hexplotpath      = os.path.join(self.plotpath, "hex_plots.eps")
        self.croprotpath      = os.path.join(self.plotpath, "rotation_cropped.eps")
        self.cropdilpath      = os.path.join(self.plotpath, "dilation_cropped.eps")
        self.cropdisppath     = os.path.join(self.plotpath, "displacement_cropped.eps")
        self.cropgammapath    = os.path.join(self.plotpath, "shear_cropped.eps")
        self.quivplotpath     = os.path.join(self.plotpath, "quiver.eps")
    ...
    def extract_strain(self):
        ...
        twist = self.extract_parameter("DiffractionPatternTwist", force_set=False, param_type=float)
